  ...
  <div style="width: 100%">
    <div class="article clearfix">
      <div v-show="!state.isLoading" :style="{'width': state.isMobileOrPc ? '100%' : '75%'}" class="article-left fl" >
        <div class="header">
          ...
          <div class="author">
            ...
            <div class="info">
              ...
              <div class="meta">
                <span class="publish-time">{{state.articleDetail.create_time? formatTime(state.articleDetail.create_time): ''}}</span>
            ...
            <div class="tags " title="标签">
              <el-tag size="mini" v-for="tag in state.articleDetail.tags" :key="tag._id" class="tag" type="success" >{{tag.name}}</el-tag>
            </div>
            <span class="clearfix" />
          </div>
        </div>
        ...
        <div class="heart">
          <el-button type="danger" size="large" icon="heart" :loading="state.isLoading" @click="likeArticle" >点赞</el-button>
        </div>
        <div class="comment">
          <el-input
