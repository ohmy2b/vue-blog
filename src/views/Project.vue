<template>
  <div class="project left">
    <el-row :gutter="20">
      <el-col class="el-col-pointer" :span="state.isMobileOrPc ? 24 : 12" v-for="(l, index) in state.list" :key="l._id" style="margin-bottom: 20px" >
...
import { getScrollTop, getDocumentHeight, getWindowHeight, timestampToTime, isMobileOrPc, } from "../utils/utils";
import { Params, ProjectList, ProjectsData } from "../types/index";

export default defineComponent({
  name: "Project",
  components: { LoadEnd, LoadingCustom,},
  setup() {
