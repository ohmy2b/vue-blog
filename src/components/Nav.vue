<template>
  <div>
    ...
    >
      <div class="nav-content">
        <el-row :gutter="20">
          ...
          <el-col :span="16">
            <el-menu
              :router="true" :default-active="state.activeIndex" active-text-color="#409eff"
          ...
          <el-col v-if="userInfo._id" :span="5">
            <div class="nav-right">
              <el-dropdown @command="handleLogout">
                ...
                <img v-else class="user-img" :src="userInfo.avatar" alt="BiaoChenXuYing">
    ...
    <div v-else class="nav">
      ...
      <div v-if="state.isShow" class="nav-mobile-content" :class="{'enter-slideUp': state.enterSlideUp,'leave-slideDown': state.leaveSlideDown}">
        <div class="list">
          ...
          <div v-else @click="handleClickMenu('/logout')" class="item">登 出</div>
        </div>
      </div>
    </div>
    <div v-if="state.isShow" class="mask" :class="{'mask-fade-out': state.leaveSlideDown}" @click="handleHideMenu"></div>
    <RegisterAndLogin :visible="state.visible" :isMobile="state.isMobile" :handleFlag="state.handleFlag" @ok="handleOk" @cancel="handleCancel"></RegisterAndLogin>
  </div>
</template>
