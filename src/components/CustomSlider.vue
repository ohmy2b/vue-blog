<template>
  <div class="right slider">
    ...
    <div class="tags">
      ...
      <router-link v-for="item in state.list" class="item" :key="item._id" :to="`/articles?tag_id=${item._id}&tag_name=${item.name}&category_id=`">
    ...
    <div class="introduce">
      ...
      <div class="content">
        <img style="width:100%;" src="../assets/FrontEndGitHub.png" alt="前端GitHub"/>
      </div>
    </div>
  </div>
</template>
